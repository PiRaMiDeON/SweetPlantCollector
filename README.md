...
В основе архитектуры проекта лежит Zenject для обеспечения гибкого управления зависимостями. UniWebView был использован для интеграции веб-интерфейсов в игру, а Newtonsoft Json для сериализации и сохранения данных. Начиналось с базовой системы управления полками и покупкой грибов, а затем постепенно были внедрены экономика, таймер роста растений, и магазин с различными апгрейдами. 
